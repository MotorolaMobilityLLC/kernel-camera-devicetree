...
CAMERA_DEVICETREE_ROOT=$(KERNEL_SRC)/$(M)/../camera-devicetree-legacy/$(TARGET_PRODUCT)
CAMERA_KERNEL_ROOT=$(CAMERA_DEVICETREE_ROOT)/../../../opensource/camera-kernel-legacy/$(TARGET_PRODUCT)

KBUILD_OPTIONS += CAMERA_DEVICETREE_ROOT=$(KERNEL_SRC)/$(M)/../camera-devicetree-legacy/$(TARGET_PRODUCT)
KBUILD_OPTIONS += KBUILD_DTC_INCLUDE=$(CAMERA_KERNEL_ROOT)
KBUILD_OPTIONS += KBUILD_EXTMOD_DTS=../camera-devicetree-legacy/$(TARGET_PRODUCT)
